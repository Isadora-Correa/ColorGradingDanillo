...
const MODULES = [
  { id: 1, order: 1, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Apresentação', title_en: 'Introduction', lessons_pt: ['Visão geral do curso e da jornada de aprendizado', 'Acesso ao Material do Curso', 'Grupo no Discord'], lessons_en: ['Course overview and learning journey', 'Access to the course materials', 'Discord group'] },
  { id: 2, order: 2, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Project Manager', title_en: 'Project Manager', lessons_pt: ['Como baixar o DaVinci Resolve', 'Configuração da Biblioteca e Database'], lessons_en: ['How to download DaVinci Resolve', 'Library and Database setup'] },
  { id: 3, order: 3, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Conform', title_en: 'Conform', lessons_pt: ['O que é Conform?', 'AAF', 'EDL', 'XML', 'Scene Detection', 'Conselhos Gerais'], lessons_en: ['What is conform?', 'AAF', 'EDL', 'XML', 'Scene Detection', 'General tips'] },
  { id: 4, order: 4, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Personalização e Atalhos', title_en: 'Customization and Shortcuts', lessons_pt: ['Configurações essenciais antes de colorir'], lessons_en: ['Essential settings before grading'] },
  { id: 5, order: 5, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Interface do DaVinci Resolve', title_en: 'DaVinci Resolve Interface', lessons_pt: ['O essencial da aba Edit para Color Grading', 'O essencial da Aba Color'], lessons_en: ['Edit page essentials for color grading', 'Color page essentials'] },
  { id: 6, order: 6, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Gerenciamento de Cor: Básico', title_en: 'Color Management: Basic', lessons_pt: ['Fundamentos do Gerenciamento de Cor', 'Gerenciamento de Cor na Prática'], lessons_en: ['Color management fundamentals', 'Color management in practice'] },
  { id: 7, order: 7, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Ferramentas Fundamentais do Color Grading', title_en: 'Fundamental Color Grading Tools', lessons_pt: ['Color Balance: Conceitos', 'Primaries', 'Scopes', 'Printer Lights', 'HDR Color Wheels', 'Color Matching com Parade', 'Color Matching com Vectorscope'], lessons_en: ['Color Balance: concepts', 'Primaries', 'Scopes', 'Printer Lights', 'HDR Color Wheels', 'Color matching with Parade', 'Color matching with Vectorscope'] },
  { id: 8, order: 8, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Gerenciamento de Cor: Avançado', title_en: 'Color Management: Advanced', lessons_pt: ['Gerenciamento de Cor', 'ACES', 'Camera RAW', 'RCM', 'Gerenciamento de Cor a Nível de Nodes'], lessons_en: ['Color management', 'ACES', 'Camera RAW', 'RCM', 'Node-level color management'] },
  { id: 9, order: 9, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Nodes e Workflow Avançado', title_en: 'Advanced Nodes and Workflow', lessons_pt: ['Nodes e Workflow Avançado na Prática'], lessons_en: ['Advanced nodes and workflow in practice'] },
  { id: 10, order: 10, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Ferramentas Secundárias', title_en: 'Secondary Tools', lessons_pt: ['Curves', 'Color Warper', 'Color Slice', 'Power Window', 'Qualifiers', 'Magic Mask', 'Keyframes', 'Noise Reduction', 'Color Checker'], lessons_en: ['Curves', 'Color Warper', 'Color Slice', 'Power Window', 'Qualifiers', 'Magic Mask', 'Keyframes', 'Noise Reduction', 'Color Checker'] },
  { id: 11, order: 11, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Tratamento de Pele / Skin Tones', title_en: 'Skin Treatment / Skin Tones', lessons_pt: ['Vectorscope: Revisão', 'Correção de Pele com Cor Subtrativa', 'Tratamento de Pele', 'Redução de Ruído', 'Glow', 'Tratamento de Pele e Face Refinement', 'Patch Replacer', 'Beauty'], lessons_en: ['Vectorscope: review', 'Skin correction with subtractive color', 'Skin treatment', 'Noise reduction', 'Glow', 'Skin treatment and Face Refinement', 'Patch Replacer', 'Beauty'] },
  { id: 12, order: 12, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Color Balance e Color Matching', title_en: 'Color Balance and Color Matching', lessons_pt: ['Color Balance: Consolidação do Aprendizado'], lessons_en: ['Color Balance: learning consolidation'] },
  { id: 13, order: 13, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Criação de Look', title_en: 'Look Creation', lessons_pt: ['O que são LUTS?', 'Film Print Emulation (FPE)', 'Cineon Film Log', 'Grão de película', 'O que é Halation', 'Aplicação de Look com "Nava LUTS"'], lessons_en: ['What are LUTs?', 'Film Print Emulation (FPE)', 'Cineon Film Log', 'Film grain', 'What is halation?', 'Applying a look with "Nava LUTS"'] },
  { id: 14, order: 14, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Projeto Prático 01', title_en: 'Practical Project 01', lessons_pt: ['Grading completo do início ao fim', 'Correção primária, secundária e look'], lessons_en: ['Full grading from start to finish', 'Primary, secondary and look correction'] },
  { id: 15, order: 15, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Projeto Prático 02', title_en: 'Practical Project 02', lessons_pt: ['Continuação da timeline do Módulo 03', 'Grading completo de um novo material', 'Exercício de autonomia e tomada de decisão'], lessons_en: ['Timeline continuation from Module 03', 'Full grading of new footage', 'Autonomy and decision-making exercise'] },
  { id: 16, order: 16, show_in_en: true, show_in_course: true, show_in_luts: false, title_pt: 'Deliver e Conform Final', title_en: 'Final Deliver and Conform', lessons_pt: ['Exportação de Timeline: Formatos e Métodos', 'Handles e Exportação de Clips Individuais'], lessons_en: ['Timeline export: formats and methods', 'Handles and individual clip export'] },
  { id: 17, order: 17, show_in_en: false, show_in_course: true, show_in_luts: false, title_pt: 'Bônus: DaVinci Resolve 20', title_en: 'Bonus: DaVinci Resolve 20', lessons_pt: ['Atualizando o DaVinci Resolve', 'Chroma Warp: Introdução', 'Chroma Warp', 'Depth Map', 'Magic Mask com IA (V2)', 'Node Stack Layer', 'ProRes no Windows', 'ACES 2.0'], lessons_en: ['Updating DaVinci Resolve', 'Chroma Warp: introduction', 'Chroma Warp', 'Depth Map', 'Magic Mask with AI (V2)', 'Node Stack Layer', 'ProRes on Windows', 'ACES 2.0'] },
];
...
export default function CourseModules({ modules = [], content = {}, productType = 'course' }) {
  ...
  const filteredModules = useMemo(
    () =>
      (Array.isArray(modules) && modules.length > 0 ? modules : MODULES)
        ...
        .filter((m) => {
          if (productType === 'luts') return m.show_in_luts === true;
          return m.show_in_course !== false;
        })
        .sort((a, b) => (a.order || 0) - (b.order || 0)),
    [modules, language, productType]
  );
  ...
  return (
    <SectionBlock gradient>
      <SectionTitle
        line1={t(content.modules_title_line1_pt || 'Grade do', content.modules_title_line1_en || 'Course')}
        highlight={t(content.modules_highlight_pt || 'Curso', content.modules_highlight_en || 'Curriculum')}
        singleLine
        subtitle={t(
          content.modules_subtitle_pt || 'Tudo o que você vai aprender',
          content.modules_subtitle_en || 'Everything you will learn'
        )}
      />
